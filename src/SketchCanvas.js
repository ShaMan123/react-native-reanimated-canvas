...
import { createNativeWrapper, PanGestureHandler, State as GHState, NativeViewGestureHandler } from 'react-native-gesture-handler';
    ...
    renderBaseView() {
        ...
        return (
            <RNSketchCanvas
                ...
                handleTouchesInNative={handleTouchesInNative}
            />
        );
    }
